...
public class EmailVerificationService {
    ...
    private String generateVerificationCode() {
        ...
        int lowerBound = (int) Math.pow(10, CODE_LENGTH - 1);
        int upperRange = (int) Math.pow(10, CODE_LENGTH) - lowerBound;
        int code = lowerBound + random.nextInt(upperRange);
    ...
    public void sendSignupVerificationCode(String email) {
        ...
        try {
            ...
            sendViaBrevo(normalizedEmail, "FlavorFrame - Verify Your Email", emailText);

            // Store the code only after successful delivery request.
